@echo off
:: eBay Tools Complete Installer v3.0.0
...
title eBay Tools Complete Installer v3.0.0
color 0A
...
echo ==========================================
echo.
echo eBay Tools v3.0.0 has been successfully installed/updated!
echo.
...
echo.
echo Thank you for using eBay Tools v3.0.0!
echo.
pause